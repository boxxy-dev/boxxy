...
- **`engine/tools/`**: Contains the implementations for `SysShellTool`, `FileWriteTool`, `ActivateSkillTool`, and global orchestration tools (`ReadPaneTool`, `SetGlobalIntentTool`, `ListActiveAgentsTool`).
