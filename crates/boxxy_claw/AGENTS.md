...
- **Deep Reasoning Headroom**: The engine allows for up to **20 tool-calling turns** per interaction, providing sufficient space for complex, multi-step diagnostic and repair workflows without hitting "max turn" limits.
